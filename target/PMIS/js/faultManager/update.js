    ...
    function (config) {
        ...
        require(['jquery', 'bootstrap', 'common/dt', 'common/commonMethod', 'common/slider', 'common/dateFormat', 'common/select2', 'common/pinyin'],
            function ($, bootstrap, dataTable, CMethod) {
                 ...
                 * 初始化时间框
                 */
                function initDatetimepicker(startDate,endDate) {
                    $.datetimepicker.setLocale('ch');
                    $('#' + id).datetimepicker({
                        format: 'Y-m-d H:i',
                        startDate:startDate,
                ...
                var sheetTable = dataTable('sheetTable', {
                    ...
                    columnDefs: [{
                        ...
                        data: function (row) {
                            ...
                            str+= '<a class="modifySheet btn btn-info btn-xs" data-toggle="modal" href="#updateSheetTypeModal" title="修改部分故障"><span class="glyphicon glyphicon-edit" style="color: red;"></span></a>&nbsp;&nbsp;'
                            return str;
                        }
                    }],
                    ordering: false,
