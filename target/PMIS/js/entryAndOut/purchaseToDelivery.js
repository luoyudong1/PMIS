        ...
        require(['jquery', 'bootstrap', 'common/dt', 'common/commonMethod', 'common/slider', 'common/dateFormat', 'common/select2', 'common/pinyin'],
            function ($, bootstrap, dataTable, CMethod) {
                ...
                var sheetTable = dataTable('sheetTable', {
                    bAutoWidth: false,
                    ajax: {
                        url: config.basePath + '/entryAndOut/purchaseToDelivery/getAllSheets',
                        type: 'GET',
                        data: function (d) {
                ...
                var tblPartsInfo = dataTable(
                    'tblPartsInfo',
                    {
                        ...
                        ajax: {
                            url: config.basePath
                                + '/entryAndOut/purchaseToDelivery/getAllPartsByStock',
                            type: 'get',
                            data: function (d) {
                ...
                $('#sheetTable tbody').on('click', 'tr',
                    function (e) { // 获取当前单号
                        if (sheetTable.data().any()) {
                            ...
                            sheetDetailTable.ajax.url(config.basePath + '/entryAndOut/purchaseToDelivery/getAllSheetDetails?' + params).load();
                        }
                    });
                ...
                var sheetDetailTable = dataTable('sheetDetailTable', {
                    ...
                    ajax: {
                        type: 'POST',
                        data: "",
                        url: config.basePath + '/entryAndOut/purchaseToDelivery/getAllSheetDetails'
                    },
                    columns: [
                        {
                            data: null
                ...
                $('#addSheetModal').on('show.bs.modal',
                    function () {
                        // 单据ID为单据类型+部门id+序列号
                        if (deptId < 10) {
                            var sheetId = "20-0" + deptId + "-";
                        } else {
                            var sheetId = "20-" + deptId + "-";
                        }
                        $.ajax({
                ...
                $("#btnAddSheetOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/purchaseToDelivery/createSheetInfo',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $("#btnPopPartsOk").click(function () {
                    ...
                    $.ajax({
                        url: config.basePath + '/entryAndOut/purchaseToDelivery/sheetDetailBatchCreate',
                        type: "post",
                        data: list,
                        contentType: 'application/json',
                        dataType: "json",
                        success: function (result) {
                            if (result.code != 0) {
                                ...
                                tblPartsInfo.ajax.reload()
                                sheetDetailTable.column(0).search('');
                                sheetDetailTable.ajax.url(config.basePath + '/entryAndOut/purchaseToDelivery/getAllSheetDetails?' + param).load();
                ...
                $("#btnAddSheetDetailOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/purchaseToDelivery/SheetDetailCreate',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                            success: function (result) {
                                if (result.code != 0) {
                                    ...
                                    tblPartsInfo.ajax.reload()
                                    sheetDetailTable.column(0).search('');
                                    sheetDetailTable.ajax.url(config.basePath + '/entryAndOut/purchaseToDelivery/getAllSheetDetails?' + json).load();
                                    $("#alertMsg").html('<span style="color:green;text-align:center"><strong>入库配件信息添加成功！</strong></span>');
                                    $("#infoAlert").show();
                                    hideTimeout("infoAlert", 2000);
                ...
                $("#btnModifySheetOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/purchaseToDelivery/modify',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $('#btnPopSheetOk').on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/purchaseToDelivery/delete',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $('#btnPopOk').on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/purchaseToDelivery/SheetDetailDeleteByCode',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $("#btnModifySheetDetailOk").click(function () {
                    ...
                    $.ajax({
                        url: config.basePath + '/entryAndOut/purchaseToDelivery/SheetDetailModify',
                        type: "post",
                        data: params,
                        contentType: 'application/json',
                        dataType: "json",
