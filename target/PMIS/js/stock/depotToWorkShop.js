    ...
    function(config) {
        ...
        require(['jquery', 'bootstrap', 'common/dt', 'common/commonMethod', 'common/slider', 'common/dateFormat', 'common/select2', 'common/pinyin'],
            function($, bootstrap, dataTable, CMethod) {
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/stock/depotToWorkShop/getAllSourceStoreHouse",
                    data: sourceParams,
                    dataType: 'json',
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/stock/depotToWorkShop/getAllReceiptStoreHouse",
                    data: {"depotId":deptId},
                    dataType: 'json',
                    success: function(result) {
                        for (var i = 0; i < result.data.length; i++) {
                ...
                var sheetTable = dataTable('sheetTable', {
                    bAutoWidth: false,
                    ajax: {
                        url: config.basePath + '/stock/depotToWorkShop/getAllSheets',
                        type: 'GET',
                        data: function(d) {
                ...
                var tblPartsInfo = dataTable(
                    'tblPartsInfo',
                    {
                        ...
                        ajax : {
                            url : config.basePath
                                + '/stock/depotToWorkShop/getAllPartsByStock',
                            type : 'get',
                            data : function(d) {
                ...
                $('#sheetTable tbody').on('click', 'tr',
                    function(e) { // 获取当前单号
                        if (sheetTable.data().any()) {
                            ...
                            sheetDetailTable.column(0).search('');
                            sheetDetailTable.ajax.url(config.basePath + '/stock/depotToWorkShop/getAllSheetDetails?' + params).load();
                        }
                    });
                ...
                var sheetDetailTable = dataTable('sheetDetailTable', {
                    ...
                    ajax: {
                        type: 'POST',
                        data: "",
                        url: config.basePath + '/stock/depotToWorkShop/getAllSheetDetails'
                    },
                    columns: [
                        {
                            data : null
                ...
                $('#addSheetModal').on('show.bs.modal',
                    function() {
                        // 单据ID为单据类型+部门id+序列号
                        if (deptId < 10) {
                            var sheetId = "19-0" + deptId + "-";
                        } else {
                            var sheetId = "19-" + deptId + "-";
                        }
                        $.ajax({
                ...
                $("#btnAddSheetOk").on('click',
                    function(e) {
                        ...
                        var params = JSON.stringify({
                            ...
                            assetAttributesId:$('#assetAttributesNameAdd').val()
                        });
                        $.ajax({
                            url: config.basePath + '/stock/depotToWorkShop/createSheetInfo',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $("#btnPopPartsOk").click(function(){
                    ...
                    $.ajax({
                        url: config.basePath + '/stock/depotToWorkShop/sheetDetailBatchCreate',
                        type: "post",
                        data: list,
                        contentType: 'application/json',
                        dataType: "json",
                        success: function(result) {
                            if (result.code != 0) {
                                ...
                                tblPartsInfo.ajax.reload()
                                sheetDetailTable.column(0).search('');
                                sheetDetailTable.ajax.url(config.basePath + '/stock/depotToWorkShop/getAllSheetDetails?' + param).load();
                ...
                $("#btnAddSheetDetailOk").on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/depotToWorkShop/SheetDetailCreate',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                            success: function(result) {
                                if (result.code != 0) {
                                    ...
                                    tblPartsInfo.ajax.reload()
                                    sheetDetailTable.column(0).search('');
                                    sheetDetailTable.ajax.url(config.basePath + '/stock/depotToWorkShop/getAllSheetDetails?' + json).load();
                                    $("#alertMsg").html('<span style="color:green;text-align:center"><strong>入库配件信息添加成功！</strong></span>');
                                    $("#infoAlert").show();
                                    hideTimeout("infoAlert", 2000);
                ...
                $("#btnModifySheetOk").on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/depotToWorkShop/modify',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $('#btnPopSheetOk').on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/depotToWorkShop/delete',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $('#btnPopOk').on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/depotToWorkShop/SheetDetailDeleteByCode',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $("#btnModifySheetDetailOk").click(function(){
                    ...
                    $.ajax({
                        url: config.basePath + '/stock/depotToWorkShop/SheetDetailModify',
                        type: "post",
                        data: params,
                        contentType: 'application/json',
                        dataType: "json",
