    ...
    function(config) {
        ...
        require(['jquery', 'bootstrap', 'common/dt', 'common/commonMethod', 'common/slider', 'common/dateFormat', 'common/select2', 'common/pinyin'],
            function($, bootstrap, dataTable, CMethod) {
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/stock/sparesToWorkShop/getAllSourceStoreHouse",
                    data: sourceParams,
                    dataType: 'json',
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/stock/sparesToWorkShop/getAllReceiptStoreHouse",
                    data: {"depotId":deptId},
                    dataType: 'json',
                    success: function(result) {
                        for (var i = 0; i < result.data.length; i++) {
                ...
                var sheetTable = dataTable('sheetTable', {
                    bAutoWidth: false,
                    ajax: {
                        url: config.basePath + '/stock/sparesToWorkShop/getAllSheets',
                        type: 'GET',
                        data: function(d) {
                ...
                var tblPartsInfo = dataTable(
                    'tblPartsInfo',
                    {
                        ...
                        ajax : {
                            url : config.basePath
                                + '/stock/sparesToWorkShop/getAllPartsByStock',
                            type : 'get',
                            data : function(d) {
                ...
                $('#addSheetModal').on('show.bs.modal',
                    function() {
                        // 单据ID为单据类型+部门id+序列号
                        if (deptId < 10) {
                            var sheetId = "17-0" + deptId + "-";
                        } else {
                            var sheetId = "17-" + deptId + "-";
                        }
                        $.ajax({
                ...
                $("#btnAddSheetOk").on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/sparesToWorkShop/createSheetInfo',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $("#btnPopPartsOk").click(function(){
                    ...
                    $.ajax({
                        url: config.basePath + '/stock/sparesToWorkShop/sheetDetailBatchCreate',
                        type: "post",
                        data: params,
                        contentType: 'application/json',
                        dataType: "json",
                        success: function(result) {
                            if (result.code != 0) {
                                ...
                                tblPartsInfo.ajax.reload()
                                sheetDetailTable.column(0).search('');
                                sheetDetailTable.ajax.url(config.basePath + '/stock/sparesToWorkShop/getAllSheetDetails?' + param).load();
                ...
                $("#btnAddSheetDetailOk").on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/sparesToWorkShop/SheetDetailCreate',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                            success: function(result) {
                                if (result.code != 0) {
                                    ...
                                    tblPartsInfo.ajax.reload()
                                    sheetDetailTable.column(0).search('');
                                    sheetDetailTable.ajax.url(config.basePath + '/stock/sparesToWorkShop/getAllSheetDetails?' + json).load();
                                    $("#alertMsg").html('<span style="color:green;text-align:center"><strong>入库配件信息添加成功！</strong></span>');
                                    $("#infoAlert").show();
                                    hideTimeout("infoAlert", 2000);
                ...
                $("#btnModifySheetOk").on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/sparesToWorkShop/modify',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $('#btnPopSheetOk').on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/sparesToWorkShop/delete',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $('#btnPopOk').on('click',
                    function(e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/stock/sparesToWorkShop/SheetDetailDeleteByCode',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $("#btnModifySheetDetailOk").click(function(){
                    ...
                    $.ajax({
                        url: config.basePath + '/stock/sparesToWorkShop/SheetDetailModify',
                        type: "post",
                        data: params,
                        contentType: 'application/json',
                        dataType: "json",
