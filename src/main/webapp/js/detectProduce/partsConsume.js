...
require(
    ...
    function(config) {
        ...
        require([ 'datetimepicker' ], function() {
            ...
            initDatetimepicker("faultDateModify", new Date());
            /**
             * 初始化时间框
             */
        ...
        require(
            ...
            function($, bootstrap, dataTable, CMethod) {
                ...
                var role= window.parent.user.roleName; // 登录人角色信息
                 ...
                 */
                var sourceParams;
                if(role.indexOf("车间")!= -1) {
                        sourceParams = JSON.stringify({
                        depotId: deptId,
                        type: 13
                    })
                }else if(role.indexOf("班组")!= -1) {
                    sourceParams = JSON.stringify({
                        depotId: deptId,
                        type: 6
                    })
                ...
                $.ajax({
                    async:false,
                    url : config.basePath
                        + "/detectProduce/partsConsume/getStoreHouseByDepotId",
                    type:'POST',
                ...
                $
                    .ajax({
                        url : config.basePath
                            + "/detectManage/detectManage/listDetect",
                        type:'get',
                        data: {
                            "depotId": deptId},
                        dataType: 'json',
                ...
                var sheetTable = dataTable(
                    'sheetTable',
                    {
                        ...
                        ajax : {
                            url : config.basePath
                                + '/detectProduce/partsConsume/getAllSheets',
                            type : 'GET',
                            data : function(d) {
                                d.sheetId = "%"
                                    + $('#sheet_id').val()
                ...
                var tblPartsInfo = dataTable(
                    'tblPartsInfo',
                    {
                        ...
                        ajax: {
                            url: config.basePath
                                + '/detectProduce/partsConsume/getAllPartsByStock',
                            type: 'get',
                            data: function (d) {
                        ...
                        function(e) { // 获取当前单号
                            if (sheetTable.data().any()) {
                                ...
                                sheetDetailTable.ajax
                                    .url(
                                        config.basePath
                                        + '/detectProduce/partsConsume/getAllSheetDetails?'
                                        + params)
                                    .load();
                            }
                        });
                ...
                $('#addSheetModal')
                    .on(
                        ...
                        function() {
                            // 单据ID为单据类型+部门id+序列号
                            if (deptId < 10) {
                                var sheetId = "21-0" + deptId
                                    + "-";
                            } else {
                                var sheetId = "21-" + deptId
                                    + "-";
                            }
                            $
                                .ajax({
                    ...
                    .on(
                        ...
                        function(e) {
                            ...
                            $
                                .ajax({
                                    url : config.basePath
                                        + '/detectProduce/partsConsume/createSheetInfo',
                                    type : "post",
                                    data : params,
                                    contentType : 'application/json',
                                    dataType : "json",
                    ...
                    .on(
                        ...
                        function(e) {
                            ...
                            $
                                .ajax({
                                    url : config.basePath
                                        + '/detectProduce/partsConsume/modify',
                                    type : 'POST',
                                    data : params,
                                    contentType : 'application/json',
                                    dataType : "json",
                    ...
                    .on(
                        ...
                        function(e) {
                            ...
                            $
                                .ajax({
                                    url : config.basePath
                                        + '/detectProduce/partsConsume/delete',
                                    type : 'POST',
                                    data : params,
                                    contentType : 'application/json',
                                    dataType : 'json',
                    ...
                    .on(
                        ...
                        function(e) {
                            ...
                            $
                                .ajax({
                                    url : config.basePath
                                        + '/detectProduce/partsConsume/SheetDetailDeleteByCode',
                                    type : 'POST',
                                    data : params,
                                    contentType : 'application/json',
                                    dataType : 'json',
                ...
                function batchCreateSheetDetail(condition) {
                    ...
                    $.ajax({
                        url: config.basePath + '/detectProduce/partsConsume/sheetDetailBatchCreate',
                        type: "post",
                        data: list,
                        contentType: 'application/json',
                        dataType: "json",
                        success: function (result) {
                            if (result.code != 0) {
                                ...
                                tblPartsInfo.ajax.reload()
                                sheetDetailTable.ajax.url(config.basePath + '/detectProduce/partsConsume/getAllSheetDetails?' + json).load();
                ...
                function createSheetDetail(trData) {
                    ...
                    o.usedStationName=detectDeviceName;
                    o.usedStationId=detectDeviceId;
                    ...
                    .click(
                        function() {
                            ...
                            $
                                .ajax({
                                    url : config.basePath
                                        + '/detectProduce/partsConsume/SheetDetailModify',
                                    type : "post",
                                    data : params,
                                    contentType : 'application/json',
                                    dataType : "json",
