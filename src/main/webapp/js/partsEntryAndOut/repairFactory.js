    ...
    function (config) {
        ...
        require(['jquery', 'bootstrap', 'common/dt', 'common/commonMethod', 'common/slider', 'common/dateFormat', 'common/select2', 'common/pinyin'],
            function ($, bootstrap, dataTable, CMethod) {
                ...
                var partId = ''//配件id
                var partCode = ''//配件出厂编码
                var sourceStoreHouseId = ''//配件出厂编码
                var objectStoreHouseId = ''//配件出厂编码
                /**
                 * 查询
                 */
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/partsEntryAndOut/repairFactory/getAllSourceStoreHouse",
                    data: params,
                    type: 'get',
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/partsEntryAndOut/repairFactory/getAllReceiptStoreHouse",
                    data: {
                        "action": "all"
                    },
                    dataType: 'json',
                ...
                var sheetTable = dataTable('sheetTable', {
                    bAutoWidth: false,
                    ajax: {
                        url: config.basePath + '/partsEntryAndOut/repairFactory/getAllSheets',
                        type: 'GET',
                        data: function (d) {
                ...
                var tblPartsInfo = dataTable('tblPartsInfo', {
                    bAutoWidth: false,
                    ajax: {
                        url: config.basePath + '/partsEntryAndOut/repairFactory/getAllParts',
                        type: 'get',
                        data: function (d) {
                ...
                $('#sheetTable tbody').on('click', 'tr',
                    function (e) { // 获取当前单号
                        if (sheetTable.data().any()) {
                            ...
                            sheetDetailTable.column(0).search('');
                            sheetDetailTable.ajax.url(config.basePath + '/partsEntryAndOut/repairFactory/getAllSheetDetails?' + params).load();
                        }
                    });
                ...
                var sheetDetailTable = dataTable('sheetDetailTable', {
                    ...
                    ajax: {
                        type: 'GET',
                        data: "",
                        url: config.basePath + '/partsEntryAndOut/repairFactory/getAllSheetDetails'
                    },
                    columns: [{
                        data: null
                    },
                ...
                $("#btnAddSheetOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/partsEntryAndOut/repairFactory/createSheetInfo',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $("#btnAddSheetDetailOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/partsEntryAndOut/repairFactory/SheetDetailCreate',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                            success: function (result) {
                                if (result.code != 0) {
                                    ...
                                    tblPartsInfo.ajax.reload()
                                    sheetDetailTable.ajax.url(config.basePath + '/partsEntryAndOut/repairFactory/getAllSheetDetails?' + json).load();
                ...
                $("#btnModifySheetOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/partsEntryAndOut/repairFactory/modifyVerify',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $('#btnPopSheetOk').on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/partsEntryAndOut/repairFactory/delete',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                function batchCreateSheetDetail(condition) {
                    ...
                    $.ajax({
                        url: config.basePath + '/partsEntryAndOut/repairFactory/sheetDetailBatchCreate',
                        type: "post",
                        data: list,
                        contentType: 'application/json',
                        dataType: "json",
                ...
                $('#btnPopOk').on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/partsEntryAndOut/repairFactory/SheetDetailDeleteByCode',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
