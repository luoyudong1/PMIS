    ...
    function (config) {
        ...
        require(['jquery', 'bootstrap', 'common/dt', 'common/commonMethod', 'common/slider', 'common/dateFormat', 'common/select2', 'common/pinyin', 'zTree'],
            function ($, bootstrap, dataTable, CMethod) {
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/detectManage/detectManage/getDeviceModel",
                    data: {
                        "action": "all"
                    },
                    dataType: 'json',
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/detectManage/detectManage/getManageDepot",
                    data: {
                        "depotId": deptId
                    },
                    dataType: 'json',
                ...
                var sheetDetailTable = dataTable('sheetDetailTable', {
                    ...
                    ajax: {
                        ...
                        url: config.basePath + '/detectManage/detectManage/listDetectParts'
                    },
                    columns: [{
                        data: 'detectPartsId'
                    }, {
                ...
                var tblPartsInfo = dataTable('tblPartsInfo', {
                    bAutoWidth: false,
                    ajax: {
                        url: config.basePath + '/detectManage/detectManage/getViewParts',
                        type: 'get',
                        dataType: 'json',
                        contentType: "application/json",
                        data: function (d) {
                ...
                $("#btnAddSheetOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/detectManage/detectManage/createDetect',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $("#btnAddSheetDetailOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/detectManage/detectManage/detectPartsCreate',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $('#btnPopSheetOk').on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/detectManage/detectManage/delete',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $('#btnPopOk').on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/detectManage/detectManage/detectPartsDelete',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
