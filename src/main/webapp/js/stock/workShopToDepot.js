...
function(config) {
    ...
    function($, bootstrap, dataTable, CMethod) {
        ...
        $.ajax({
            async: false,
            url: config.basePath + "/stock/workShopToDepot/getAllSourceStoreHouse",
            data: sourceParams,
            dataType: 'json',
        ...
        $.ajax({
            async: false,
            url: config.basePath + "/stock/workShopToDepot/getAllReceiptStoreHouse",
            data: {"depotId":deptId},
            dataType: 'json',
            success: function(result) {
                for (var i = 0; i < result.data.length; i++) {
		...
		var tblPartsInfo = dataTable(
				'tblPartsInfo',
				{
					...
					ajax : {
						url : config.basePath
								+ '/stock/workShopToDepot/getAllPartsByStock',
						type : 'get',
						data : function(d) {
        ...
        function() {
            // 单据ID为单据类型+部门id+序列号
            if (deptId < 10) {
                var sheetId = "15-0" + deptId + "-";
            } else {
                var sheetId = "15-" + deptId + "-";
            }
            $.ajax({
 ...
 */
        ...
        function(e) {
            ...
            $.ajax({
                url: config.basePath + '/stock/workShopToDepot/createSheetInfo',
                type: "post",
                data: params,
                contentType: 'application/json',
                dataType: "json",
        ...
        $("#btnPopPartsOk").click(function(){
			...
			$.ajax({
                url: config.basePath + '/stock/workShopToDepot/sheetDetailBatchCreate',
                type: "post",
                data: list,
                contentType: 'application/json',
                dataType: "json",
                success: function(result) {
                    if (result.code != 0) {
                        ...
                        tblPartsInfo.ajax.reload()
                         sheetDetailTable.column(0).search('');
                        sheetDetailTable.ajax.url(config.basePath + '/stock/workShopToDepot/getAllSheetDetails?' + param).load();
 ...
 */
        ...
        function(e) {
            ...
            $.ajax({
                url: config.basePath + '/stock/workShopToDepot/SheetDetailCreate',
                type: "post",
                data: params,
                contentType: 'application/json',
                dataType: "json",
                success: function(result) {
                    if (result.code != 0) {
                        ...
                        tblPartsInfo.ajax.reload()
                        sheetDetailTable.column(0).search('');
                        sheetDetailTable.ajax.url(config.basePath + '/stock/workShopToDepot/getAllSheetDetails?' + json).load();
                        $("#alertMsg").html('<span style="color:green;text-align:center"><strong>入库配件信息添加成功！</strong></span>');
                        $("#infoAlert").show();
                        hideTimeout("infoAlert", 2000);
        ...
        function(e) {
            ...
            $.ajax({
                url: config.basePath + '/stock/workShopToDepot/modify',
                type: 'POST',
                data: params,
                contentType: 'application/json',
                dataType: "json",
        ...
        function(e) {
            ...
            $.ajax({
                url: config.basePath + '/stock/workShopToDepot/delete',
                type: 'POST',
                data: params,
                contentType: 'application/json',
                dataType: 'json',
        ...
        function(e) {
            ...
            $.ajax({
                url: config.basePath + '/stock/workShopToDepot/SheetDetailDeleteByCode',
                type: 'POST',
                data: params,
                contentType: 'application/json',
                dataType: 'json',
        ...
        $("#btnModifySheetDetailOk").click(function(){
             ...
             $.ajax({
                 url: config.basePath + '/stock/workShopToDepot/SheetDetailModify',
                 type: "post",
                 data: params,
                 contentType: 'application/json',
                 dataType: "json",
