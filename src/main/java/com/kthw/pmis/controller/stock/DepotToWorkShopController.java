...
@Transactional
@Controller
@RequestMapping(value = "/stock/depotToWorkShop")
public class DepotToWorkShopController {
    private static Logger logger = LoggerFactory.getLogger(DepotToWorkShopController.class);
    @Autowired
    ...
    public DataTable<StoreHouse> getAllReceiptStoreHouse(
        ...
        if(depotId!=null) {
            ...
            params.put("eqType", (short)13);//班组上级车间送修库类型
