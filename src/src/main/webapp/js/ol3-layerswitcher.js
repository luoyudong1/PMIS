(function (root, factory) {
  if(typeof define === "function" && define.amd) {
     ...
     * @param lyrs, lyr_par, elm 20190412 cjx add
     */
    ol.control.LayerSwitcher.prototype.renderLayer_ = function(lyr, idx, lyrs, lyr_par, elm) {
            ...
            if (lyrTitle == "全选") {
            	...
            	input.onchange = function(e) {
            		...
            		if (qxBoo) {
            			...
            			elm.innerHTML = "";
            			this_.renderLayers_(lyr_par, elm);
            		} else {
            			for (var i = 0, l; i < lyrs.length; i++) {
            				l = lyrs[i]
            				if (l.get('title')) {
    ...
    ol.control.LayerSwitcher.prototype.renderLayers_ = function(lyr, elm) {
        ...
        for (var i = 0, l; i < lyrs.length; i++) {
            l = lyrs[i];
            if (l.get('title')) {
                elm.appendChild(this.renderLayer_(l, i, lyrs, lyr, elm));
            }
        }
    };
