...
function(config) {
    ...
    function($, bootstrap, dataTable, CMethod) {
        ...
        $.ajax({
            async: false,
            url: config.basePath + "/stock/workShopReceipt/getAllReceiptStoreHouse",
            data: {
                "action": "all"
            },
            dataType: 'json',
        ...
        var sheetTable = dataTable('sheetTable', {
            bAutoWidth: false,
            ajax: {
                url: config.basePath + '/stock/workShopReceipt/getAllSheets',
                type: 'GET',
                data: function(d) {
        ...
        function(e) { // 获取当前单号
            if (sheetTable.data().any()) {
                ...
                sheetDetailTable.column(0).search('');
                sheetDetailTable.ajax.url(config.basePath + '/stock/workShopReceipt/getAllSheetDetails?' + params).load();
            }
        });
        ...
        var sheetDetailTable = dataTable('sheetDetailTable', {
            ...
            ajax: {
                type: 'POST',
                data: "",
                url: config.basePath + '/stock/workShopReceipt/getAllSheetDetails'
            },
            columns: [
            	{
					data : null
        ...
        function(e) {
            ...
            $.ajax({
                url: config.basePath + '/stock/workShopReceipt/modify',
                type: 'POST',
                data: params,
                contentType: 'application/json',
                dataType: "json",
        ...
        function() {
            ...
            $("#parts_id_select").val(trData.partIdSeq);
            ...
            $("#part_idAdd").val(trData.partIdSeq);
        ...
        $("#btnModifySheetDetailOk").click(function(){
             ...
             $.ajax({
                 url: config.basePath + '/stock/workShopReceipt/SheetDetailModify',
                 type: "post",
                 data: params,
                 contentType: 'application/json',
                 dataType: "json",
                 success: function(result) {
                     if (result.code != 0) {
                         ...
                         sheetDetailTable.ajax.url(config.basePath + '/stock/workShopReceipt/getAllSheetDetails?' + json).load();
