...
function(config) {
    ...
    function($, bootstrap, dataTable, CMethod) {
        ...
        $.ajax({
            async: false,
            url: config.basePath + "/stock/depotReceipt/getAllReceiptStoreHouse",
            data: {
                "action": "all"
            },
            dataType: 'json',
        ...
        $("#btnModifySheetDetailOk").click(function(){
             ...
             $.ajax({
                 url: config.basePath + '/stock/depotReceipt/SheetDetailModify',
                 type: "post",
                 data: params,
                 contentType: 'application/json',
                 dataType: "json",
                 success: function(result) {
                     if (result.code != 0) {
                         ...
                         sheetDetailTable.ajax.url(config.basePath + '/stock/depotReceipt/getAllSheetDetails?' + json).load();
