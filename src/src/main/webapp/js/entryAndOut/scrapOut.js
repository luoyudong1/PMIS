    ...
    function (config) {
        ...
        require(['datetimepicker'],
            function () {
                ...
                initDatetimepicker("checkedDateAdd", new Date());
                initDatetimepicker("checkedDateModify", new Date());
        ...
        require(['jquery', 'bootstrap', 'common/dt', 'common/commonMethod', 'common/slider', 'common/dateFormat', 'common/select2', 'common/pinyin'],
            function ($, bootstrap, dataTable, CMethod) {
                ...
                $.ajax({
                    async: false,
                    url: config.basePath + "/entryAndOut/scrapOut/getAllReceiptStoreHouse",
                    data: {
                        "action": "all"
                    },
                    dataType: 'json',
                ...
                var sheetTable = dataTable('sheetTable', {
                    bAutoWidth: false,
                    ajax: {
                        url: config.basePath + '/entryAndOut/scrapOut/getAllSheets',
                        type: 'GET',
                        data: function (d) {
                    ...
                    columnDefs: [{
                        ...
                        data: function (row) {
                            ...
                            if (row.sendVerifyFlag == 0 || row.sendVerifyFlag == 3) {
                                str += '<a class="btn btn-primary btn-xs openCmdDetail" data-toggle="modal" href="#SheetVerifyOkModal" title="提交" > <span class="glyphicon glyphicon-ok"></span></a>&nbsp;&nbsp;'
                                    + '<a class="deleteSheet btn btn-danger btn-xs" data-toggle="modal" href="#popSheetModal" title="删除"><span class="glyphicon glyphicon-remove"></span></a>&nbsp;&nbsp;';
                            } else {
                                str += '';
                            }
                ...
                var tblPartsInfo = dataTable(
                    'tblPartsInfo',
                    {
                        ...
                        ajax: {
                            url: config.basePath
                                + '/entryAndOut/scrapOut/getAllPartsByStock',
                            type: 'get',
                            data: function (d) {
                                d.sheetId = sheet_id2;
                                d.partId = '%'
                ...
                $('#sheetTable tbody').on('click', 'tr',
                    function (e) { // 获取当前单号
                        if (sheetTable.data().any()) {
                            ...
                            objectStoreHouseId = sheetTrData.objectStoreHouseId;
                            var params = $.param({
                                sheetId: sheet_id2
                            });
                            ...
                            sheetDetailTable.column(0).search('');
                            sheetDetailTable.ajax.url(config.basePath + '/entryAndOut/scrapOut/getAllSheetDetails?' + params).load();
                        }
                    });
                ...
                var sheetDetailTable = dataTable('sheetDetailTable', {
                    ...
                    ajax: {
                        type: 'POST',
                        data: "",
                        url: config.basePath + '/entryAndOut/scrapOut/getAllSheetDetails'
                    },
                    columns: [
                        {
                            data: null
                ...
                $('#addSheetModal').on('show.bs.modal',
                    function () {
                        // 单据ID为单据类型+部门id+序列号
                        if (deptId < 10) {
                            var sheetId = "13-0" + deptId + "-";
                        } else {
                            var sheetId = "13-" + deptId + "-";
                        }
                        $.ajax({
                ...
                $("#btnAddSheetOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/scrapOut/createSheetInfo',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $("#btnAddSheetDetailOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/scrapOut/SheetDetailCreate',
                            type: "post",
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                            success: function (result) {
                                if (result.code != 0) {
                                    ...
                                    tblPartsInfo.ajax.reload()
                                    sheetDetailTable.ajax.url(config.basePath + '/entryAndOut/scrapOut/getAllSheetDetails?' + json).load();
                ...
                $("#btnModifySheetOk").on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/scrapOut/modify',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: "json",
                ...
                $('#btnPopSheetOk').on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/scrapOut/delete',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $('#btnPopOk').on('click',
                    function (e) {
                        ...
                        $.ajax({
                            url: config.basePath + '/entryAndOut/scrapOut/SheetDetailDeleteByCode',
                            type: 'POST',
                            data: params,
                            contentType: 'application/json',
                            dataType: 'json',
                ...
                $("#tblPartsInfo tbody").on("dblclick", "tr",
                    function () {
                        ...
                        $("#checkedUserNameAdd").val(trData.checkedUserName);
                        $("#checkedDateAdd").val(trData.checkedDate);
                        $("#scrapReasonAdd").val(trData.scrapReason);
                ...
                $("#modifySheetDetailModal").on('show.bs.modal',
                    function (e) {
                        ...
                        $("#faultInfoModify").val(trData.faultInfo);
                        $("#checkedUserNameModify").val(trData.checkedUserName);
                        $("#checkedDateModify").val(trData.checkedDate);
                        $("#scrapReasonModify").val(trData.scrapReason);
                    });
                $("#btnModifySheetDetailOk").click(function () {
                    ...
                    $.ajax({
                        url: config.basePath + '/entryAndOut/scrapOut/SheetDetailModify',
                        type: "post",
                        data: params,
                        contentType: 'application/json',
                        dataType: "json",
                ...
                function batchCreateSheetDetail(condition) {
                    ...
                    $.ajax({
                        url: config.basePath + '/entryAndOut/scrapOut/sheetDetailBatchCreate',
                        type: "post",
                        data: list,
                        contentType: 'application/json',
                        dataType: "json",
                ...
                function createSheetDetail(trData) {
                    ...
                    o.checkedUserName = trData.checkedUserName;
                    o.checkedDate = trData.checkedDate;
                    o.faultDate = trData.faultDate;
                    o.scrapReason = trData.scrapReason;
                    return o;
                }
