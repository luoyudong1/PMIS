...
public class PlanCheck {
    ...
    private String detectDepotName;
    ...
    public String getDetectDepotName() {
        return detectDepotName;
    }

    public void setDetectDepotName(String detectDepotName) {
        this.detectDepotName = detectDepotName;
    }
    ...
    public Date getOldPlanTime() {
        return oldPlanTime;
    }

    public void setOldPlanTime(Date oldPlanTime) {
        this.oldPlanTime = oldPlanTime;
    }
